 ...
 * @property integer $taskfrequency
 *
...
class BaseListing extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('byuserid, foruserid, name, length, width, area, sizeunitid, basecurrencyid, price, weeklyprice, pricedurationid, otherdata, countryid, stateid, cityid, locality, zoomlevel, lightingid, mediatypeid, pscore, datecreated, datemodified, companyId, temp_status', 'required'),
			array('product_type, byuserid, foruserid, sizeunitid, basecurrencyid, wpstatus, pricedurationid, countryid, stateid, cityid, accurate_geoloc, zoomlevel, lightingid, mediatypeid, approved, status, pscore, reach, solr, companyId, min_period_num, min_period_unit, rate_per_unit, area_code, loop_length, daily_spots, dwell_time, temp_status, new_mig_status, taskfrequency', 'numerical', 'integerOnly'=>true),
			...
			array('description, availability_start, availability_end, search_keywords, availabilitydate, taskduedate', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, product_type, site_code, byuserid, foruserid, name, length, width, area, sizeunitid, basecurrencyid, price, weeklyprice, wpstatus, pricedurationid, otherdata, countryid, stateid, cityid, locality, geolat, geolng, accurate_geoloc, zoomlevel, lightingid, mediatypeid, description, approved, status, pscore, reach, solr, datecreated, datemodified, companyId, tag1, tag2, tag3, availability_start, availability_end, min_period_num, min_period_unit, contact_name, contact_phone, contact_email, rate_per_unit, search_keywords, area_code, postal, loop_length, daily_spots, operating_hours, screen_size, dwell_time, other_type, temp_status, new_mig_status, availabilitydate, taskduedate, taskfrequency', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'product_type' => '0-eatads,1-monitorly',
			'site_code' => 'Site Code',
			'byuserid' => 'Byuserid',
			'foruserid' => 'Foruserid',
			'name' => 'Name',
			...
			'wpstatus' => 'Wpstatus',
			'pricedurationid' => '1=>Daily, 2=>Weekly, 3=>Monthly, 4=>Quarterly, 5=>Yearly',
			'otherdata' => 'Otherdata',
			'countryid' => 'Countryid',
			'stateid' => 'Stateid',
			'cityid' => 'Cityid',
			...
			'zoomlevel' => 'Zoomlevel',
			'lightingid' => '1=>No Lighting, 2=>Front Lit, 3=> Back Lit',
			...
			'datemodified' => 'not CURRENT_TIMESTAMP ON UPDATE as solr field',
			'companyId' => 'Company',
			'tag1' => 'Tag1',
			'tag2' => 'Tag2',
			'tag3' => 'Tag3',
	...
	public function search()
	{
		...
		$criteria->compare('taskduedate',$this->taskduedate,true);
		$criteria->compare('taskfrequency',$this->taskfrequency);
	 ...
	 * @return BaseListing the static model class
	 */
